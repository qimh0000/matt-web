...
function setup() {
  ...
  saveButton.position(25, 65); // Place it below the toggle button
  ...
  moveRightButton.position(63, 150);
  ...
  moveDownButton.position(35, 180);
